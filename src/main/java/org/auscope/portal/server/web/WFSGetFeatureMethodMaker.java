...
public class WFSGetFeatureMethodMaker {
    ...
    public HttpMethodBase makeMethod(String serviceURL, String featureType, String filterString, int maxFeatures, String srsName, ResultType resultType) {
        ...
        sb.append("                xmlns:wml=\"http://bom.gov.au\"\n");
        //sb.append("                outputFormat=\"gml32\"\n");
    ...
    /**
     * Makes a GetFeature method for use with a CQL filter
     */
    public HttpMethodBase makeMethodCql(String serviceURL, String featureType,
            String cqlFilterString, int maxFeatures, String srsName) {
        ...
        if (cqlFilterString.length() > 0) {
            valuePairList.add(new NameValuePair("cql_filter", cqlFilterString));
        }
