...
public abstract class BaseWFSService {
     ...
     * @throws Exception
     */
    protected HttpMethodBase generateWFSRequest(String wfsUrl, String featureType, String featureId, String filterString, boolean isFilterCql, Integer maxFeatures, String srs, ResultType resultType) {
        ...
        if (featureId == null) {
            if (isFilterCql) {
                return wfsMethodMaker.makeMethodCql(wfsUrl, featureType, filterString, max, srs);
            } else {
    ...
    protected HttpMethodBase generateWFSRequest(String wfsUrl, String featureType, String featureId, String filterString, Integer maxFeatures, String srs, ResultType resultType) {
        return generateWFSRequest(wfsUrl, featureType, featureId, filterString, false, maxFeatures, srs, resultType);
    }
