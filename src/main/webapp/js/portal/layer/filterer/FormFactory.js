    ...
    getFilterForm : function(layer) {
        ...
        if (layer.get('sourceType') === portal.layer.Layer.KNOWN_LAYER) {
            ...
            case 'wml-monthly_climate_summary':
                baseFilterForm = Ext.create('portal.layer.filterer.forms.bom.BomMonthlySummaryFilterForm', baseFilterFormCfg);
                return this._generateResult(baseFilterForm, true);
            case 'wml-daily_climate_summary':
                baseFilterForm = Ext.create('portal.layer.filterer.forms.bom.BomDailySummaryFilterForm', baseFilterFormCfg);
                return this._generateResult(baseFilterForm, true);
            case 'wml-extreme':
                baseFilterForm = Ext.create('portal.layer.filterer.forms.bom.BomExtremeFilterForm', baseFilterFormCfg);
                return this._generateResult(baseFilterForm, true);
            }
        }
