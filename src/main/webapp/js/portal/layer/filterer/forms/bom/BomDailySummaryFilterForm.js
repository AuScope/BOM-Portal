 ...
 */
Ext.define('portal.layer.filterer.forms.bom.BomDailySummaryFilterForm', {
    ...
    constructor : function(config) {
        ...
        var logOpCombo = this._buildComboCfg('Logical Operator', portal.layer.filterer.forms.bom.BomFilterForm.logOpTypeStore, 'dayOpLogic', ' AND ', 50);
        var opStation = this._buildComboCfg('', portal.layer.filterer.forms.bom.BomFilterForm.compOpTypeStore, 'dayOpStation', '=', 35);
        var opTemp = this._buildComboCfg('', portal.layer.filterer.forms.bom.BomFilterForm.compOpTypeStore, 'dayOpTemp', '=', 35);
        var opRainfall = this._buildComboCfg('', portal.layer.filterer.forms.bom.BomFilterForm.compOpTypeStore, 'dayOpRainfall', '=', 35);
        var opWindSpeed = this._buildComboCfg('', portal.layer.filterer.forms.bom.BomFilterForm.compOpTypeStore, 'dayOpWindSpeed', '=', 35);
        var opWindDirection = this._buildComboCfg('', portal.layer.filterer.forms.bom.BomFilterForm.compOpTypeStore, 'dayOpWindDirection', '=', 35);
