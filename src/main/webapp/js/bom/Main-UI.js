    ...
    launch : function() {
        ...
        var handleAddRecordToMap = function(sourceGrid, record) {
            var layerFactory = Ext.create('portal.layer.LayerFactory', {
                map : map,
                formFactory : Ext.create('bom.layer.filterer.BomFormFactory', {map : map}),
                downloaderFactory : Ext.create('bom.layer.BomDownloaderFactory', {map: map}),
                querierFactory : Ext.create('bom.layer.BomQuerierFactory', {map: map}),
                rendererFactory : Ext.create('bom.layer.BomRendererFactory', {map: map})
            });
            var newLayer = null;
