...
public class TestCSWCacheController extends PortalTestClass {
    ...
    /** The mock view csw record factory. */
    private ViewKnownLayerFactory mockViewKlFactory = context.mock(ViewKnownLayerFactory.class);
    ...
    public void setUp() throws Exception {
        ...
        cswController = new CSWCacheController(mockCSWService, mockViewCSWRecordFactory, mockViewKlFactory);
    }
